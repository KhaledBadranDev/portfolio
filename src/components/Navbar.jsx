...
const Navbar = () => {
    ...
    return (
        <navbar className='z-20 shadow-xl w-full fixed top-0 left-0'>
            <div className='container mx-auto px-20 sm:px-7 py-2 sm:flex items-center justify-between bg-white'>
                ...
                <ul className={`sm:flex grid justify-items-end sm:items-center sm:pb-0 pb-6 absolute sm:static bg-white shadow-xl sm:shadow-none sm:z-auto z-[-1] left-0 w-full sm:w-auto sm:pl-0 pl-9 transition-all duration-500 ease-in ${open ? 'top-0' : 'top-[-490px]'}`}>
                    ...
                    <li>
                        <BsFillMoonStarsFill className="sm:ml-8 mr-4 text-xl sm:my-0 mt-5 hover:text-indigo-700 duration-300" style={{ fontSize: '25px' }} />
                    </li>
                </ul>
            </div>
        </navbar>
